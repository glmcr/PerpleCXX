...
int ini_phaseq(char const inputfile[]) {
  ...
  fprintf(stdout,"ini_phaseq: START START START.\n");
  ...
  fprintf(stdout,"ini_phaseq: BEF. input1_\n");
  input1_(&first, &output, &err);  // NB. 'err' is a new option
  fprintf(stdout,"ini_phaseq: AFT. input1_, err=%d\n",err);
  ...
  fprintf(stdout,"ini_phaseq: BEF. input2_\n");
  input2_(&first);
  fprintf(stdout,"ini_phaseq: AFT. input2_\n");
  fprintf(stdout,"ini_phaseq: cst24_.jv[0]=%d\n",cst24_.jv[0]);
  fprintf(stdout,"ini_phaseq: cst24_.jv[1]=%d\n",cst24_.jv[1]);
  fprintf(stdout,"ini_phaseq: csta2_.vname[cst24_.jv[0]-1][0]=%c\n",csta2_.vname[cst24_.jv[0]-1][0]);
  fprintf(stdout,"ini_phaseq: csta2_.vname[cst24_.jv[1]-1][0]=%c\n",csta2_.vname[cst24_.jv[1]-1][0]);
  //fprintf(stdout,"ini_phaseq: exit 0\n");
  //exit(0);
  
  setau1_(&output);
  fprintf(stdout,"ini_phaseq: AFT. setau1_\n");
  //fprintf(stdout,"ini_phaseq: exit 0\n") ;
  //exit(0);
  
  input9_(&first, &output);
  fprintf(stdout,"ini_phaseq: AFT. input9_\n");
  //fprintf(stdout,"ini_phaseq: exit 0\n") ;
  //exit(0);
  
  initlp_();
  fprintf(stdout,"ini_phaseq: AFT. initlp_\n");
  //fprintf(stdout,"ini_phaseq: exit 0\n") ;
  //exit(0);
  
  print_comp_order();
  fprintf(stdout,"ini_phaseq: AFT. print_comp_order\n");
...
int phaseq(double P, double T, int ncomp, double *comp, int *nphases, 
  ...
  //fprintf(stdout,"phaseq: start: perpleX thermo. crunch.\n");
  //fprintf(stdout,"phaseq: cst24_.jv[0]=%d\n",cst24_.jv[0]);
  //fprintf(stdout,"phaseq: cst24_.jv[1]=%d\n",cst24_.jv[1]);
  //fprintf(stdout,"phaseq: csta2_.vname[cst24_.jv[0]-1][0]=%c\n",csta2_.vname[cst24_.jv[0]-1][0]);
  //fprintf(stdout,"phaseq: csta2_.vname[cst24_.jv[1]-1][0]=%c\n",csta2_.vname[cst24_.jv[1]-1][0]);
  ...
  for (i = 0; i < p_i8; i++)
    {
      ...
      //fprintf(stdout,"phaseq: (sysprop)[i]=%lf\n",(sysprop)[i])
    }
