...
1190  format (/,'**warning ver019** ',a,' is a Perple_X 691+ option it',
     ...
     *     'for a list of valid values',/)
      ...
      write(*,*)"ftn::tlib.f::redop1: end" !,vname=",vname
      !write(*,*)"ftn:: stop!"
      !stop
      end 
...
c-----------------------------------------------------------------------
      write(*,*)"ftn::tlib.f::topn2: option=",option
      write(*,*)"ftn::tlib.f::topn2: icopt=",icopt
      write(*,*)"ftn::tlib.f::topn2: lopt(14)=",lopt(14)
      !write(*,*)"ftn:: topn2: stop!"
      !stop
...
c                                 read "begin"
      ...
      do i = 1, l2
         ...
         call getkey (n2,ier,key,values,strg)
         write(*,*)"ftn::tlib.f::topn2: i=",i
         write(*,*)"ftn::tlib.f::topn2: key=",key
         write(*,*)"ftn::tlib.f::topn2: values=",values
         write(*,*)"ftn::tlib.f::topn2: strg=",strg
         
c                                 over ride default mobile component naming to 
c                                 allow build to use fugacities or activities.
         if (option.gt.3.or.i.lt.4)then
             write(*,*)"ftn::tlib.f::topn2: in if block"
             read (key,'(a8)') vname(i)
             write(*,*)"ftn::tlib.f::topn2: vname(i)=",vname(i)
         end if
         ...
         write(*,*)"ftn::tlib.f::topn2: v(i),delt(i)=",v(i),delt(i)
         write(*,*)""

      end do
      write(*,*)"ftn::tlib.f::topn2: do i = 1, l2, end do"
      !write(*,*)"ftn:: topn2: stop!"
      !stop
...
1000  format (/,' | comments are indicated by the | character.',/,
     *     ' | check for warnings at the end of the header section.',/) 
      ...
      !write(*,*)"ftn:: topn2: vname=",vname
      write(*,*)"ftn::tlib.f::topn2: END END END : vname(1)=",vname(1)
      write(*,*)"ftn::tlib.f::topn2: END END END : vname(2)=",vname(2)
      write(*,*)"ftn::tlib.f::topn2: END END END : vname(3)=",vname(3)
      !write(*,*)"ftn:: topn2: stop!"
      !stop
...
c                                 default search increment
      ...
      !ORIG subroutine input1 (first,err)
       subroutine input1 (first,outprt_arg,err) 
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      ...
      logical eof, first, err, outprt_arg
...
c     autorefine.
      ...
      !--- GM MODIF 20220318: set outprt with outprt_arg to get the
      !--- behavior that aspect's perplex.cpp code expects. 
      outprt= outprt_arg      
      write(*,*)"ftn::tlib.f::input1 start : outprt=",
     *          outprt,", err=",err
      !write(*,*)"ftn:: input1: vname=",vname
      !write(*,*)"ftn:: stop!"
      !stop
...
c                                 read name of thermodynamic data file
      ...
      !write(*,*)"ftn:: input1: n2name=",n2name
      !write(*,*)"ftn:: stop!"
      !stop
      
      call enblnk (n2name)
      write(*,*)"ftn::tlib.f::input1: n2name=",n2name
      !write(*,*)"ftn:: stop!"
      !stop
...
c                                 read print and graphic file names
      ...
      read (n1,'(a)') n9name
      call enblnk (n9name)
      write(*,*)"ftn::tlib.f::input1: n9name=",n9name
      !write(*,*)"ftn:: stop!"
      !stop
...
c                                 get first non-blank string 
      call getstg (tfname)
      write(*,*)"ftn::tlib.f::input1: tfname=",tfname
      !write(*,*)"ftn:: stop!"
      !stop      

      read (tfname,'(i2)',iostat=ierr) icopt

      write(*,*)"ftn::tlib.f::input1: ierr=",ierr
      write(*,*)"ftn::tlib.f::input1: icopt=",icopt
      !write(*,*)"ftn:: input1: stop!"
      !stop      
...
c                                 count (icp) and save names (cname)
      ...
      do 
         ...
         write(*,*)"ftn::tlib.f::input1: rname=",rname,", strg=",strg
         !write(*,*)"ftn:: input1: stop!"
         !stop         
...
c                                  jmct - mobile component counter
      ...
      do 
         ...
         write(*,*)"ftn::tlib.f::input1: nstrg=",nstrg
         write(*,*)"ftn::tlib.f::input1: string(1)=",string(1)
         write(*,*)"ftn::tlib.f::input1: string(2)=",string(2)
         write(*,*)"ftn::tlib.f::input1: string(3)=",string(3)
         write(*,*)"ftn::tlib.f::input1: eof=",eof
         !write(*,*)"ftn:: input1: stop!"
         !stop
...
c                                 chemical potential
      ...
      write(*,*)"ftn::tlib.f::input1: aft. do-enddo 2, icopt=",
     *           icopt
      !write(*,*)"ftn:: input1: stop!"
      !stop      
...
c     open files requested in input
      ...
      write(*,*)"ftn::tlib.f::input1: bef. fopen(), err=",err
      call fopen (n2name,prt,n9name,err)

      write(*,*)"ftn::tlib.f::input1: aft. fopen(), err=",
     *          err,",icopt=",icopt
      !write(*,*)"ftn:: stop!"
      !stop
c                                 err only set for unsplt (iam.eq.14)
      if (err) return
      write(*,*)"ftn::tlib.f::input1: bef. rdain, err=",
     *          err,",icopt=",icopt
...
!write(*,*)"ftn:: input1: bef. redop1, iam=",iam
      write(*,*)"ftn::tlib.f::input1: bef. redop1, first=",first
      !write(*,*)"ftn::tlib.f::input1: bef. redop1, vname=",vname
      write(*,*)"ftn::tlib.f::input1: bef. redop1, icopt=",icopt
      !write(*,*)"ftn:: stop!"
      !stop
...
998   call mertxt (n2name,prject,'.dat',0)
      ...
      !--- Seems that exec never get here, keep it just in case!
      write(*,*)"ftn::lib.f::input1 end: outprt=",outprt
      write(*,*)"ftn::tlib.f:: exec do not get here normally: -> stop!"
      stop
999   end
