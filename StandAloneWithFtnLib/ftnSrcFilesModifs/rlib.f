...
c                                 region I function
     ...
     *       -4.096745422d0)*((1d0 - rho)) **
     *       ((1.268348e-5*t - 1.767275512e-2)*t + 9.98834792d0)
...
c           m- the physical dimension of matrix a
...
c-----------------------------------------------------------------------
      ...
      integer m,ipvt(*),i,j,k,ip1,n,istr
...
1060  format (/,'Solution: ',a,/,12x,'Endmember fractions:',
     *        /,12x,20(a,1x))
1080  format (9x,'reject_bad_compositons is on for ',a)
...
c     caloric EoS. JADC 9/18/2016.
      ...
      !write(*,*)"ftn:: ginc: iam,id,dp,dt=",iam,id,dp,dt
      
      if (isnan(dp)) dp = 0d0
      if (isnan(dt)) dt = 0d0

      !write(*,*)"ftn:: ginc: p bef p= p+dp",p
      !write(*,*)"ftn:: ginc: t bef t= t+dt",t     
      
      p = p + dp
      t = t + dt

      !write(*,*)"ftn:: ginc: p aft p= p+dp",p
      !write(*,*)"ftn:: ginc: t aft t= t+dt",t
...
c                               transformations, read make definitions.
      call topn2 (0)
      !write(*,*)"ftn:: input2: vname=",vname
      !write(*,*)"ftn:: input2: stop!"
      !stop
